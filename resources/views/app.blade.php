...
<head>
	...
	<!-- librerias para ocultar y ver pass-->
	...
	<nav class="navbar navbar-default">
		<div class="container-fluid" style="background-color:#212121">
			<div class="navbar-header" >
				...
				<a class="navbar-brand" href="#" style="color:#fff">IMSUR</a>
			</div>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<ul class="nav navbar-nav navbar-right">
					@if (Auth::guest())
						<li><a href="{{ url('/login') }}" style="color:#fff">Iniciar secion</a></li>
						<li><a href="{{ url('/register') }}" style="color:#fff">Registrar</a></li>
					@else
						<li class="dropdown">
