...
class LiquidacionController extends Controller
{
    ...
    public function principal(Request $request)
    {
     ...
     // habilitar para usar con vistas
      ...
      $datos_liquido=\IMSUR\Liquidaciones::with(['proveedor_p','persona_p'])->where('estado','si')
                      ->proveer($cod_proveed)
                      ->liquidacion($cod_liquidacion)
                      ->paginate(6);
    ...
    public function mostrar($cod_liquidacion)
    {
      ...
      $code_liq = \IMSUR\Liquidaciones::with(['proveedor_p'])->where('cod_liquidacion', $cod_liquidacion)->get(); //recupera tb datos pero mas para tablas con foreach tb sirve para individuales
